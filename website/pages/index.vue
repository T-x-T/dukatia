  ...
  <main>
    ...
    <div class="feature">
      ...
      <div class="feature_text">
        <h4>Transactions</h4>
        <p>Log your transactions and add metadata like recipients, accounts, assets and tags to get better insights into your spending habits.</p>
      </div>
    </div>
    <div class="feature">
      ...
      <div class="feature_text">
        <h4>Budgets</h4>
        <p>Set yourself a budget to plan how you want to spend your money.</p>
      </div>
    </div>
    <div class="feature">
      ...
      <div class="feature_text">
        <h4>Assets</h4>
        <p>Track your financial assets to get an overview over your investments.</p>
      </div>
    </div>
    <div class="feature">
      ...
      <div class="feature_text">
        ...
        <p>Track your spending across all of your accounts.</p>
      </div>
    </div>
    <div class="feature">
      ...
      <div class="feature_text">
        ...
        <p>Tags don't just stand on their own - they can also have a parent. This lets you define a tree-like structure for all your tagging needs.</p>
      </div>
    </div>
    <div class="feature">
    ...
    <div class="feature">
      ...
      <div class="feature_text">
        ...
        <p>Your financial data tells a lot about you, so keep it safe! Dukatia is fully self-hosted and doesn't send your sensitive data to the cloud.</p>
      </div>
    </div>
