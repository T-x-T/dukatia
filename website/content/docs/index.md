...
## Installation
It is recommended to install TxTs Treasury using [docker-compose](docs/installation-docker).  
...
## First time Setup
After you successfully installed TxTs Treasury, you can go ahead and add your data!  
