...
mod calculate_get_per_tag_over_time {
	...
	fn data_default_chart() {
		let transactions: Vec<Transaction> = vec![
			Transaction::default().set_id(0).set_tag_ids(vec![0])   .set_timestamp(DateTime::parse_from_str("2020-01-01 12:34:56 +0000", "%Y-%m-%d %H:%M:%S %z").unwrap().with_timezone(&Utc)).set_total_amount(Money::from_amount(12345, 100, "€".to_string())).set_currency_id(0),
			Transaction::default().set_id(1).set_tag_ids(vec![0, 2]).set_timestamp(DateTime::parse_from_str("2020-01-01 12:34:56 +0000", "%Y-%m-%d %H:%M:%S %z").unwrap().with_timezone(&Utc)).set_total_amount(Money::from_amount(22345, 100, "$".to_string())).set_currency_id(1),
			Transaction::default().set_id(2).set_tag_ids(vec![0])   .set_timestamp(DateTime::parse_from_str("2020-01-02 12:34:56 +0000", "%Y-%m-%d %H:%M:%S %z").unwrap().with_timezone(&Utc)).set_total_amount(Money::from_amount(-12345, 100, "€".to_string())).set_currency_id(0),
			Transaction::default().set_id(3).set_tag_ids(vec![1])   .set_timestamp(DateTime::parse_from_str("2020-01-02 12:34:56 +0000", "%Y-%m-%d %H:%M:%S %z").unwrap().with_timezone(&Utc)).set_total_amount(Money::from_amount(1000, 100, "$".to_string())).set_currency_id(1),
	...
	fn data_default_chart_monthly_period() {
		...
		let transactions: Vec<Transaction> = vec![
			Transaction::default().set_id(0).set_tag_ids(vec![0])   .set_timestamp(DateTime::parse_from_str("2020-01-01 12:34:56 +0000", "%Y-%m-%d %H:%M:%S %z").unwrap().with_timezone(&Utc)).set_total_amount(Money::from_amount(12345, 100, "€".to_string())).set_currency_id(0),
			Transaction::default().set_id(1).set_tag_ids(vec![0, 2]).set_timestamp(DateTime::parse_from_str("2020-01-01 12:34:56 +0000", "%Y-%m-%d %H:%M:%S %z").unwrap().with_timezone(&Utc)).set_total_amount(Money::from_amount(22345, 100, "$".to_string())).set_currency_id(1),
			Transaction::default().set_id(2).set_tag_ids(vec![0])   .set_timestamp(DateTime::parse_from_str("2020-02-02 12:34:56 +0000", "%Y-%m-%d %H:%M:%S %z").unwrap().with_timezone(&Utc)).set_total_amount(Money::from_amount(-12345, 100, "€".to_string())).set_currency_id(0),
			Transaction::default().set_id(3).set_tag_ids(vec![1])   .set_timestamp(DateTime::parse_from_str("2020-02-02 12:34:56 +0000", "%Y-%m-%d %H:%M:%S %z").unwrap().with_timezone(&Utc)).set_total_amount(Money::from_amount(1000, 100, "$".to_string())).set_currency_id(1),
	...
	fn data_default_chart_quarterly_period() {
		...
		let transactions: Vec<Transaction> = vec![
			Transaction::default().set_id(0).set_tag_ids(vec![0])   .set_timestamp(DateTime::parse_from_str("2020-01-01 12:34:56 +0000", "%Y-%m-%d %H:%M:%S %z").unwrap().with_timezone(&Utc)).set_total_amount(Money::from_amount(12345, 100, "€".to_string())).set_currency_id(0),
			Transaction::default().set_id(1).set_tag_ids(vec![0, 2]).set_timestamp(DateTime::parse_from_str("2020-01-01 12:34:56 +0000", "%Y-%m-%d %H:%M:%S %z").unwrap().with_timezone(&Utc)).set_total_amount(Money::from_amount(22345, 100, "$".to_string())).set_currency_id(1),
			Transaction::default().set_id(2).set_tag_ids(vec![0])   .set_timestamp(DateTime::parse_from_str("2020-04-02 12:34:56 +0000", "%Y-%m-%d %H:%M:%S %z").unwrap().with_timezone(&Utc)).set_total_amount(Money::from_amount(-12345, 100, "€".to_string())).set_currency_id(0),
			Transaction::default().set_id(3).set_tag_ids(vec![1])   .set_timestamp(DateTime::parse_from_str("2020-04-02 12:34:56 +0000", "%Y-%m-%d %H:%M:%S %z").unwrap().with_timezone(&Utc)).set_total_amount(Money::from_amount(1000, 100, "$".to_string())).set_currency_id(1),
	...
	fn data_default_chart_yearly_period() {
		...
		let transactions: Vec<Transaction> = vec![
			Transaction::default().set_id(0).set_tag_ids(vec![0])   .set_timestamp(DateTime::parse_from_str("2020-01-01 12:34:56 +0000", "%Y-%m-%d %H:%M:%S %z").unwrap().with_timezone(&Utc)).set_total_amount(Money::from_amount(12345, 100, "€".to_string())).set_currency_id(0),
			Transaction::default().set_id(1).set_tag_ids(vec![0, 2]).set_timestamp(DateTime::parse_from_str("2020-01-01 12:34:56 +0000", "%Y-%m-%d %H:%M:%S %z").unwrap().with_timezone(&Utc)).set_total_amount(Money::from_amount(22345, 100, "$".to_string())).set_currency_id(1),
			Transaction::default().set_id(2).set_tag_ids(vec![0])   .set_timestamp(DateTime::parse_from_str("2021-04-02 12:34:56 +0000", "%Y-%m-%d %H:%M:%S %z").unwrap().with_timezone(&Utc)).set_total_amount(Money::from_amount(-12345, 100, "€".to_string())).set_currency_id(0),
			Transaction::default().set_id(3).set_tag_ids(vec![1])   .set_timestamp(DateTime::parse_from_str("2021-04-02 12:34:56 +0000", "%Y-%m-%d %H:%M:%S %z").unwrap().with_timezone(&Utc)).set_total_amount(Money::from_amount(1000, 100, "$".to_string())).set_currency_id(1),
